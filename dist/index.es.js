...
function ir() {
  ...
  function S(y, l, T) {
    ...
    for (v in l)
      R.call(l, v) && !A.hasOwnProperty(v) && (b[v] = l[v]);
    if (y && y.defaultProps)
      for (v in l = y.defaultProps, l)
        b[v] === void 0 && (b[v] = l[v]);
    return { $$typeof: P, type: y, key: _, ref: I, props: b, _owner: F.current };
  }
...
function ur() {
  return Re || (Re = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === R || e === A || De || e === F || e === T || e === v || ke || e === I || Se || xe || je || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === b || e.$$typeof === S || e.$$typeof === y || e.$$typeof === l || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
      ...
      var w = e ? e.displayName || e.name : "", _e = w ? $(w) : "";
